...
seid tx wasm store ./target/wasm32-unknown-unknown/release/contract_2.wasm -y --broadcast-mode=block --fees=1500000usei --gas=15000000 --from=admin -o json >> deploy.json
