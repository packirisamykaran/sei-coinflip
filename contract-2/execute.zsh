...
seid tx wasm execute sei13gqw2w0eve7e2m676tzmq62nqgps8rsftkqjam5fdxffkqjvnxwqa3y600 '{"flip_coin":{}}' --from sei1529r93wfs7j5erfvxqhvzpae35xnse9qz29hz0 --node tcp://127.0.0.1:26657 --chain-id sei-chain --gas 200000 --fees 500000usei -y --broadcast-mode block
